                                ...
                                <tr class="message-unread">
                                    ...
                                    <td>
                                        <c:if test="${user.userStatus==0}">
                                            ...
                                            }" onclick=" return confirm('您确定要锁定该用户吗?')">锁定</a>
                                        </c:if>
                                        <c:if test="${user.userStatus==1}">
                                            <a href="/user/lock?id=${user.id}" onclick=" return confirm('您确定要将该用户解锁吗?')">解锁</a>
                                        </c:if>
                                        <a href="/user/remove?id=${user.id}" onclick=" return confirm('您确定要删除该用户吗?')">删除</a>
                                    </td>
                                </tr>
                                </c:forEach>
